...
description: "Interactive mathematical model exploring peat age-depth profiles under 3 peat creep mechanisms."
---
...
Adjust the model type and slider parameters below to compare the classic **decay only** profile against the selected **creep model** profile over 10,000 years.
...
<div class="model-container">
  <div class="controls-grid">
    ...
    <div class="control-card">
      ...
      <small id="modelHelpText">Select vertical creep velocity profile</small>
...
function readInputs() {
  ...
  return { modelType, A_kg, alpha, uRefCmYr, uRefMYr };
}
...
function solveODE(params) {
  ...
  // Baseline total final mass for reference
  const M_baseline_final = (A_kg / alpha) * (1 - Math.exp(-alpha * MODEL_CONSTANTS.years));
  ...
  const M_act = 1.5 * MODEL_CONSTANTS.bulkDensity; // 150 kg/m2 (top 1.5m)
